...
public class CodecoolerQuestManager implements HttpHandler {
    ...
    public void handle(HttpExchange httpExchange) throws IOException {
        try {
            ...
            if(method.equals("GET")){
                List userQuestList = userQuestDao.getUserQuests();

                String artifactJSON = objectMapper.writeValueAsString(userQuestList);
                HttpCookie cookie = new HttpCookie("userQuestList", artifactJSON);
